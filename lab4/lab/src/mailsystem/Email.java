...
public class Email {
	...
	/**
	 * Checks if 2 Email object have same values on every property.
	 * Overrides equals method from Object superclass.
	 */
	public boolean equals(Object pmail) {
		if (pmail == null) return false;
		
		if (pmail.getClass() != this.getClass()) return false;
		
		// Check every attribute
		final Email mail = (Email) pmail;
		return sender.equals(mail.getSender()) &&
			   receiver.equals(mail.getReceiver()) &&
			   subject.equals(mail.getSubject()) &&
			   text.equals(mail.getText());
	}
